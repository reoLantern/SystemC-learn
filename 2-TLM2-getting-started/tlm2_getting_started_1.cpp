...
struct Initiator : sc_module
{
    ...
    void thread_process()
    {
        ...
        for (int i = 32; i < 96; i += 4)
        {
            ...
            cout << "Initiator: Before call b_transport, data=" << hex << data << " at time " << sc_time_stamp() << "," << sc_delta_count_at_current_time() << endl;

            socket->b_transport(*trans, delay); // Blocking transport call

            cout << "Initiator: After  call b_transport, data=" << hex << data << " at time " << sc_time_stamp() << "," << sc_delta_count_at_current_time() << endl;
...
struct Memory : sc_module
{
    ...
    virtual void b_transport(tlm::tlm_generic_payload &trans, sc_time &delay)
    {
        ...
        // cout << "target b_transport() called at time " << sc_time_stamp() << "," << sc_delta_count_at_current_time() << endl;
